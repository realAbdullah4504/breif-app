...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Managers can view team briefs" ON briefs;
  DROP POLICY IF EXISTS "Admins have full access to workspace settings" ON workspace_settings;
  DROP POLICY IF EXISTS "All users can view workspace settings" ON workspace_settings;
EXCEPTION
