/*
  ...
  1. Recreate Views
    - Drop and recreate `stripe_user_subscriptions` view with proper security
    - Drop and recreate `stripe_user_orders` view with proper security
    
  2. Security
    - Ensure views use security_invoker for proper RLS
