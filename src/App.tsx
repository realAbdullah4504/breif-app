...
const ProtectedRoute: React.FC<{
  ...
  console.log('Auth state:', { isAuthenticated, role: currentUser?.role, isLoading });
        ...
        <ThemeProvider>
          <AuthProvider>
            <Router>
              <Routes>
                {/* Public Routes */}
                <Route path="/" element={<ProtectedRoute element={<AdminDashboardPage />} requiredRole="admin" />} />
                  ...
                  element={
                    <ErrorBoundary fallback={
                      <div className="min-h-screen flex items-center justify-center bg-gray-50">
                        <div className="text-center">
                          <h1 className="text-xl font-bold text-gray-900 mb-2">Dashboard Error</h1>
                          <p className="text-gray-600">Unable to load member dashboard</p>
                        </div>
                      </div>
                    }>
                      <ProtectedRoute
