        ...
        <div className="mb-10">
            ...
            >
                <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                    ...
                    <div>
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight">Team Dashboard</h1>
                        <p className="text-gray-600 text-sm sm:text-base">Track daily submissions and team progress</p>
                    </div>
                </div>
            </motion.div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    This is example data to show how your dashboard will look. Delete it when you're ready to invite your team.
                                </p>
                            </div>
                        </div>
                        <Button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 relative z-10">
                        <div>
                            ...
                            <p className="text-xs sm:text-sm text-gray-500 mt-1">
                                {submittedBriefs === totalBriefs ? "All done!" : "Great progress"}
                            </p>
                        </div>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 relative z-10">
                        <div>
                            ...
                            <p className="text-xs sm:text-sm text-gray-500 mt-1">
                                {timeUntilDeadline} • {getWorkspaceTimezoneAbbr(settings?.timezone || DEFAULT_WORKSPACE_TIMEZONE)}
                            </p>
                        </div>
                        <div className="text-left sm:text-right w-full sm:w-auto">
                            <p className="text-xs sm:text-sm text-gray-600 mb-2">
                ...
                >
                    <div className={`absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 ${pendingBriefs > 0 ? 'bg-gradient-to-br from-danger-500 to-danger-600' : 'bg-gradient-to-br from-success-500 to-success-600'} opacity-10 rounded-full -mr-12 sm:-mr-16 -mt-12 sm:-mt-16`}></div>
                    
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-6 relative z-10">
                        <div className="flex items-center">
                            <div className={`${pendingBriefs > 0 ? 'bg-danger-50' : 'bg-success-50'} p-3 sm:p-4 rounded-2xl mr-3 sm:mr-4 shadow-sm`}>
                                {pendingBriefs > 0 ? (
                            ...
                            <div>
                                ...
                                <p className="text-xs sm:text-sm text-gray-600">
                                    {pendingBriefs === 0 
                                        ...
                                        : `${pendingBriefs} ${pendingBriefs === 1 ? 'member hasn\'t' : 'members haven\'t'} submitted`
                                    }
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 relative z-10">
                        <div>
                            <p className={`text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight ${pendingBriefs > 0 ? 'text-danger-600' : 'text-success-600'}`}>
