...
import { CheckCircle, Eye, EyeOff, ArrowRight, Lock, Mail, User, Building, AlertTriangle, Sparkles, Zap, Users, BarChart3 } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err?.message?.includes('Unable to connect')) {
        ...
        setError('Unable to connect to the authentication service. The app is now running in demo mode.');
      } else {
          ...
          >
            ...
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white to-white/80">
                {inviteToken ? `with ${workspaceName}` : "with better team communication"}
              </span>
            </h1>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                {password && (
                  <div className="mt-3">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs font-medium text-gray-500 whitespace-nowrap">{passwordFeedback}</span>
                    </div>
              ...
              {inviteToken && (
                <div>
                  ...
                  <div className="flex items-center px-4 py-4 border-2 border-gray-200 rounded-xl bg-gray-50">
                    ...
                    <span className="text-base text-gray-700">{workspaceName}</span>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="terms" className="ml-3 block text-sm text-gray-700">
                  I agree to the{' '}
                  <a href="#" className="text-primary-600 hover:text-primary-500 font-semibold">
                    Terms of Service
                  </a>{' '}
                  and{' '}
                  <a href="#" className="text-primary-600 hover:text-primary-500 font-semibold">
